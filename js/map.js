function Map(){
	let map=[
		...
		['block','trap' ,'block','air'  ,'air'  ,'air'  ,'air'  ,'trap' ,'air'  ,'air'  ,'air'  ,'block','block'],
		['block','air'  ,'air'  ,'air'  ,'air'  ,'air'  ,'air'  ,'air'  ,'block','air'  ,'air'  ,'block','block'],
		['block','air'  ,'air'  ,'air'  ,'air'  ,'air'  ,'block','air'  ,'block','air'  ,'air'  ,'block','block'],
		['block','trap' ,'block','air'  ,'air'  ,'air'  ,'air'  ,'air'  ,'air'  ,'air'  ,'air'  ,'air'  ,'block'],
		['block','air'  ,'air'  ,'air'  ,'air'  ,'air'  ,'air'  ,'air'  ,'block','air'  ,'air'  ,'block','block'],
		['block','air'  ,'air'  ,'air'  ,'air'  ,'air'  ,'air'  ,'air'  ,'air'  ,'air'  ,'air'  ,'air'  ,'block'],
		['block','air'  ,'air'  ,'block','trap' ,'air'  ,'trap' ,'block','air'  ,'air'  ,'block','air'  ,'block'],
		['block','air'  ,'trap' ,'trap' ,'air'  ,'trap' ,'air'  ,'trap' ,'trap' ,'trap' ,'trap' ,'trap' ,'block'],
		['block','block','block','block','block','block','block','block','block','block','block','block','block'],
	];
	function check(x,y){
